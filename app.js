...
function joinRoom(id) {
  ...
  roomRef.on("value", snapshot => {
    ...
    if (val.timer) {
      localState.duration = val.timer.duration || localState.duration;
      localState.running = val.timer.running || false;
      localState.startTs = val.timer.startTs || null;
      localState.pauseRemaining = val.timer.pauseRemaining || null;
    }
